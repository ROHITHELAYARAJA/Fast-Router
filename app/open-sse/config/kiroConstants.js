 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what Fast-Router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a Fast-Router
 ...
 * The suffix is a Fast-Router request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a Fast-Router synthetic agentic variant.
...
/**
 * Detect whether a model id is a Fast-Router synthetic thinking variant
...
/**
 * Resolve a Fast-Router model id to the real upstream Kiro model id, plus flags
