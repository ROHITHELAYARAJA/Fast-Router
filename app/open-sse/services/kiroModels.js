 ...
 * into Fast-Router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are Fast-Router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic Fast-Router variant set for a single upstream Kiro model.
 *
 ...
 * into Fast-Router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
