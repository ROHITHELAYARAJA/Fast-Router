...
const endpoints = createStore({
  storageKey: "Fast-Router.cliToolEndpointPresets",
  changeEvent: "Fast-Router:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "Fast-Router.cliToolApiKeyPresets",
  changeEvent: "Fast-Router:api-key-presets-changed",
  itemField: "key",
});
