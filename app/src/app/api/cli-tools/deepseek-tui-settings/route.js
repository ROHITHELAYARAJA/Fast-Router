...
const PROVIDER_NAME = "Fast-Router";
...
// Build TOML config for Fast-Router (openai provider mode)
const buildFastRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect Fast-Router by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildFastRouterConfig(baseUrl, apiKey || "sk_FastRouter", model);
