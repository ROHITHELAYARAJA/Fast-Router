...
const hasFastRouterConfig = (settings) => Boolean(settings?.model?.base_url);
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Fast-Router model slots removed from Grok Build",
    });
  } catch (error) {
