...
// and break recursive loops between Fast-Router instances connected to each other.
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // Fast-Router instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another Fast-Router fetching our /models)
