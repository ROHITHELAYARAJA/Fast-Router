...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/ROHITHELAYARAJA/Fast-Router/refs/heads/main/CHANGELOG.md",
  donateUrl: "",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "fast-router",
  installCmd: "npm i -g fast-router",
  installCmdLatest: "npm i -g fast-router@latest --prefer-online",
