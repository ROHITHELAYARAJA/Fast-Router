...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/Fast-Router/server.js.
...
function buildCliPackage() {
  console.log("📦 Building Fast-Router CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.Fast-Router/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.Fast-Router/runtime)");
  }
  console.log("");
