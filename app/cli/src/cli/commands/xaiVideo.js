/**
 * `Fast-Router xai video` — generate a Grok Imagine video through the local
 * Fast-Router gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: Fast-Router xai video --prompt "..." [options]

Generate a Grok Imagine video via your local Fast-Router gateway
...
Options:
  ...
  --api-key <key>         Fast-Router API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-Fast-Router-connection-id"] || null;
