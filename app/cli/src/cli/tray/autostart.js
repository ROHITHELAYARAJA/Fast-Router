...
const APP_NAME = "Fast-Router";
const APP_LABEL = "com.Fast-Router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when Fast-Router is currently
 ...
 * SIGTERM to the running process. When the running Fast-Router cli.js was itself
...
<dict>
    ...
    <string>/tmp/Fast-Router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/Fast-Router.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `Fast-Router.cmd` lookup that depended on the npm prefix path.
