...
**Brand Name:** Fast-Router

This skill defines the core constraints for visual design and technical implementation for Fast-Router. You must adhere to these guidelines strictly to maintain consistency across the dashboard, CLI, and runtime components.
